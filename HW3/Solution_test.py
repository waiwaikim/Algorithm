    ...
    def output_vector(self):
        ...
        for i in range(len(self.in_vector)-1,-1,-1):
            ...
            if i == (len(self.in_vector)-1):
                return_vector[i] = self.in_vector[i] * r[i]
               
            else:
                return_vector[i] = (return_vector[i+1]/r[i+1] + self.in_vector[i]) * r[i] 
        '''
        ...
        for i in range(len(self.in_vector)-1,-1,-1):
            ...
            if i == (len(self.in_vector)-1):
                ...
                return_vector[i] = return_vector[i+1] + (self.in_vector[i] * r[i])
